                                            ...
                                            <div id="<?php echo $club['carousel_id'][0]; ?>" class="carousel slide">
                                                ...
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active c-item">
                                                        <img src="<?php echo $club['img-active'][0]['url']; ?>"
                                                            class="d-block w-100 c-img"
                                                            alt="<?php echo $club['img-active'][0]['alt']; ?>">
                                                    </div>

                                                    <div class="carousel-item c-item">
                                                        <img src="<?php echo $club['images'][0]['url']; ?>"
                                                            class="d-block w-100 c-img"
                                                            alt="<?php echo $club['images'][0]['alt']; ?>">
                                                    </div>
                                                    <div class="carousel-item c-item">
                                                        <img src="<?php echo $club['images'][1]['url']; ?>"
                                                            class="d-block w-100 c-img"
                                                            alt="<?php echo $club['images'][1]['alt']; ?>">
                                                    </div>
                                                </div>
