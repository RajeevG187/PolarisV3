    ...
    <body onload="closePreloader()">
      ...
      ?>
        ...
        <section class="section">
            <div class="container">
                <h2 class="heading-secondary">Sports Facilties</h2>
                <div class="clubs">
                    ...
                    <br>
                    <h3 class="heading-tertiary">General Secretary - Lalit Gour</h3>
                ...
                <div class="sports">
                    ...
                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Co-ordinator:</span> Amarjeet Kumar</p><br>
                    ...
                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Past Events: </span> Prayatna 2k22</p><br>

                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Upcoming Events: </span> Prayatna 2k23 , Various Tournaments in Raipur</p>
                </div>
                ...
                <div class="sports">
                    ...
                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Co-ordinator:</span> Sanyam Sharma and Nukala Shreya</p><br>
                    ...
                    <div class="row">
                        <div class="col-1-of-2"><img src="../public/images/life/badminton-1.JPG" alt="Badminton" class="sports__photo"></div>
                        <div class="col-1-of-2"><img src="../public/images/life/badminton-2.JPG" alt="Badminton" class="sports__photo"></div>
                    </div>
                ...
                <div class="sports">
                    ...
                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Co-ordinator:</span> Vanshika and Karan Sunil Kumbhar</p><br>
                    ...
                    <div class="row">
                        <div class="col-1-of-2"><img src="../public/images/life/bb-1.JPG" alt="Basketball" class="sports__photo"></div>
                        <div class="col-1-of-2"><img src="../public/images/life/bb-2.JPG" alt="Basketball" class="sports__photo"></div>
                    </div>
                ...
                <div class="sports">
                    <h3 class="heading-tertiary">Table Tennis</h3>
                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Co-ordinator:</span> Nishchay Rajput and Ishita Saxena</p><br>
                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>About: </span>Table Tennis is a fast game that requires skills to win. This is the reason for its popularity all around the world. This year our first TT Boys team participated in INTER IIT Sports Meet 2017 in Madras. </p><br>

                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Facilities:</span> We have one TT Table in every Hostel. Sports Coaches and TT Coordinator are always available for any guidance and support. </p><br>
                    ...
                    <div class="row">
                        <div class="col-1-of-2"><img src="../public/images/life/tt-1.JPG" alt="Table Tennis" class="sports__photo"></div>
                        <div class="col-1-of-2"><img src="../public/images/life/tt-2.JPG" alt="Table Tennis" class="sports__photo"></div>
                    </div>
                ...
                <div class="sports">
                    ...
                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Co-ordinator:</span> Pravar Gupta</p><br>
                ...
                <div class="sports">
                    ...
                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Co-ordinator:</span> Shivam Shrivastava</p><br>
                    ...
                    <div class="row">
                        <div class="col-1-of-2"><img src="../public/images/life/chess-1.JPG" alt="Chess" class="sports__photo"></div>
                        <div class="col-1-of-2"><img src="../public/images/life/chess-2.JPG" alt="Chess" class="sports__photo"></div>
                    </div>
                ...
                <div class="sports">
                    ...
                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Co-ordinator:</span> Ankadala Hemanth and Esha Jain</p><br>
                    ...
                    <div class="row">
                        <div class="col-1-of-2"><img src="../public/images/life/volley-1.JPG" alt="Volleyball" class="sports__photo"></div>
                        <div class="col-1-of-2"><img src="../public/images/life/volley-2.JPG" alt="Volleyball" class="sports__photo"></div>
                    </div>
