      ...
      ?>
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="clubs">
                    <p class="outreach__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Follow us: </span><a href="<?php echo $data['header']['link']; ?>" class="outreach__link">Facebook</a></p>
                    <br>
                ...
                <div class="sports">
                    ...
                    <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span><?php echo $sport['role']; ?></span><?php echo $sport['leader']; ?></p><br>

                    <?php if (!empty($sport['about'])): ?>
                        <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>About: </span><?php echo $sport['about']; ?></p><br>
                    <?php endif; ?>

                    <?php if (!empty($sport['facilities'])): ?>
                        <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Facilities: </span><?php echo $sport['facilities']; ?></p><br>
                    <?php endif; ?>  

                    <?php if (!empty($sport['objective'])): ?>
                        <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Objective: </span><?php echo $sport['objective']; ?></p><br>
                    <?php endif; ?>

                    <?php if (!empty($sport['activities'])): ?>
                        <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span>Activities: </span><?php echo $sport['activities']; ?></p><br>
                    <?php endif; ?>

                    <?php if (!empty($sport['past-events'])): ?>
                        <?php foreach ($sport['past-events'] as $pastevent): ?>    
                            <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span><?php echo $pastevent['head']; ?></span><?php echo $pastevent['text']; ?></p><br>
                        <?php endforeach; ?>
                    <?php endif; ?>

                    <?php if (!empty($sport['upcoming-events'])): ?>
                        <?php foreach ($sport['upcoming-events'] as $upcomingevent): ?>
                            <p class="sports__text"><i class="fas fa-arrow-circle-right"></i>&nbsp;<span><?php echo $upcomingevent['head']; ?></span><?php echo $upcomingevent['text']; ?></p><br>
                        <?php endforeach; ?>
                    <?php endif; ?>
                    ...
                    <?php if (!empty($sport['image'])): ?>
                        <div class="row">
                            <?php foreach ($sport['image'] as $images): ?>
                                <div class="col-1-of-2"><img src="<?php echo $images['path']; ?>" alt="<?php echo $images['alt']; ?>" class="sports__photo"></div>
                            <?php endforeach; ?>        
                        </div>    
                    <?php endif; ?>  
